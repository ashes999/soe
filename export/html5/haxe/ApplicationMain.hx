...
class ApplicationMain {
	...
	private static function preload() {
		...
		loadFile("assets/graphics/ui/title.png");
		loadFile("assets/graphics/blackout.png");
		loadFile("assets/graphics/originals/gallery_2356_7_504823.png");
		loadFile("assets/graphics/originals/shin-t14.jpg");
		loadFile("assets/graphics/originals/10nthnb.jpg");
		loadFile("assets/graphics/originals/rpg_maker_tiles_by_ayene_chan-d48exyx.png");
		loadFile("assets/graphics/top-down/house-1.png");
		loadFile("assets/graphics/top-down/cave-entrance.png");
		loadFile("assets/graphics/top-down/outside.png");
		loadFile("assets/graphics/top-down/hero-1.png");
