...
class DefaultAssetLibrary extends openfl.AssetLibrary {
	...
	public function new() {
		...
		add("assets/graphics/ui/title.png", IMAGE);
		add("assets/graphics/blackout.png", IMAGE);
		add("assets/graphics/originals/gallery_2356_7_504823.png", IMAGE);
		add("assets/graphics/originals/shin-t14.jpg", IMAGE);
		add("assets/graphics/originals/10nthnb.jpg", IMAGE);
		add("assets/graphics/originals/rpg_maker_tiles_by_ayene_chan-d48exyx.png", IMAGE);
		add("assets/graphics/top-down/house-1.png", IMAGE);
		add("assets/graphics/top-down/cave-entrance.png", IMAGE);
		add("assets/graphics/top-down/outside.png", IMAGE);
		add("assets/graphics/top-down/hero-1.png", IMAGE);
