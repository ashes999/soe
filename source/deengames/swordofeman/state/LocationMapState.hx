...
{
	private static inline var TILE_WIDTH = 64;
	private static inline var TILE_HEIGHT = 64;
	...
	override public function create():Void
	{
		...
		for (y in 0 ... verticalTiles) {
			for (x in 0 ... horizontalTiles) {
				...
				tile.loadGraphic("assets/images/map/outside.png", true, TILE_WIDTH, TILE_HEIGHT);
				tile.x = x * TILE_WIDTH;
		...
		player.loadGraphic("assets/images/map/hero-1.png", true, TILE_WIDTH, TILE_HEIGHT);
